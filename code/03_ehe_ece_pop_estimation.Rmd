...
params: 
  ehe_threshold_param: 0.5
  ece_threshold_param: -0.5
  idw_param: 2
  number_of_grid_cells_param: 1020100 #~600m
  spatial_projection_param: 4269 #NAD83
  join_type_param: "st_intersects"
  start_date_param: as.Date("2019-01-01", format="%Y-%m-%d")
  end_date_param: as.Date("2019-12-31", format="%Y-%m-%d")
---
...
ehe_threshold <- params$ehe_threshold_param
ece_threshold <- params$ece_threshold_param

idw <- params$idw_param
number_of_grid_cells <- params$number_of_grid_cells_param

join_type <- params$join_type_param
spatial_projection <- params$spatial_projection_param
```
